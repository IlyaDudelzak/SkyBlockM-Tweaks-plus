...
public class SmoothTargetBot {
    ...
    public static void register() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            // Проверяем, жива ли еще цель и находится ли в том же мире
            if (!targetEntity.isAlive() || targetEntity.getWorld() != client.player.getWorld()) {
                targetEntity = null;
                return;
            }
            ...
            Vec3d targetPos = targetEntity.getPos().add(0, targetEntity.getHeight() / 2.0, 0);
